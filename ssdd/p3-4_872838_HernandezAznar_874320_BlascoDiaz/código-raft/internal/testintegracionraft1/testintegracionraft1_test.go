...
func (cfg *configDespliegue) falloAnteriorElegirNuevoLiderTest3(t *testing.T) {
	...
	// Volvemos a lanzar los procesos
...
func (cfg *configDespliegue) tresOperacionesComprometidasEstable(t *testing.T) {
	...
	// somete tres operaciones secuenciales
...
func (cfg *configDespliegue) AcuerdoApesarDeSeguidor(t *testing.T) {
	...
	// Se asegura de que todas las réplicas tengan el mismo logger
	cfg.checkLoggers(6)
...
func (cfg *configDespliegue) SinAcuerdoPorFallos(t *testing.T) {
	...
	// Comprobar que varios acuerdos fallan debido a que solo está el líder conectado
...
// Reinicia los procesos que estuvieran detenidos
...
// Muestra el estado remoto de un nodo
